...
function cms_admin_enqueue_scripts() {
	...
	if ( cms_tpv_is_one_of_our_pages() ) {
		...
		$oLocale = array(
			...
			"Status_password"                             => __( "protected", 'cms-tree-page-view' ),
			// is "protected" word better than "password" ?
			...
			"Status_password_ucase"                       => ucfirst( __( "protected", 'cms-tree-page-view' ) ),
			// is "protected" word better than "password" ?
...
function cms_tpv_promo_above_wrapper() {
    ...
    <div class="cms_tpv_promo_above_wrapper">
        ...
        <p>Do you like this plugin? Then <a
                    href="https://wordpress.org/support/view/plugin-reviews/cms-tree-page-view#topic">give it a nice
                review</a>!</p>
        ...
        <form method="post" action="options.php" class="cmtpv_options_form">
            ...
            <p class="submit">
                <input type="submit" class="button-primary"
                       value="<?php _e( 'Save Changes', 'cms-tree-page-view' ) ?>"/>
            </p>
...
function cms_tpv_print_common_tree_stuff( $post_type = "" ) {
    ...
    <div class="cms_tpv_wrapper">
        ...
        <input type="hidden" name="cms_tpv_meta_post_type_hierarchical"
               value="<?php echo (int) cms_tpv_is_post_type_hierarchical( $post_type_object ) ?>"/>
		...
		if ( true ) {
            ...
            <div class="updated below-h2 hidden cms_tpv_search_no_hits">
                <p><?php _e( "Search: no pages found", 'cms-tree-page-view' ) ?></p></div>
                    ...
                    <form method="post" action="<?php echo admin_url( 'admin-ajax.php', 'relative' ); ?>">
                        ...
                        <div>
                            ...
                            <label><input type="radio" name="cms_tpv_add_status"
                                          value="published"> <?php current_user_can( 'publish_posts' ) ? _e( "Published", "cms-tree-page-view" ) : _e( "Submit for Review", "cms-tree-page-view" ) ?>
                            </label>
                        </div>

                        <div>
                            <input type="submit" value="<?php _e( "Add", "cms-tree-page-view" ) ?>"
...
function cms_tpv_add_page() {
	...
	*/
	...
	if ( ! $page_title ) {
		$page_title = __( "New page", 'cms-tree-page-view' );
	}
...
function cms_tpv_show_annoying_box() {
	...
	if ( $show_box ) {
        ...
        <div class="cms_tpv_annoying_little_box">
            ...
            <p class="cms_tpv_annoying_little_box_gravatar"><a
                        href="https://twitter.com/eskapism"><?php echo get_avatar( "par.thernstrom@gmail.com", '64' ); ?></a>
            </p>
            <p><?php _e( 'Hi there! I just wanna says thanks for using my plugin. I hope you like it as much as I do.', 'cms-tree-page-view' ) ?></p>
            <p class="cms_tpv_annoying_little_box_author"><a
                        href="https://twitter.com/eskapism"><?php _e( '/Pär Thernström - plugin creator', 'cms-tree-page-view' ) ?></a>
            </p>
